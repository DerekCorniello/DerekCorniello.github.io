...
`+s):i.stack=s}catch{}}throw i}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=Yi(this.defaults,n);const{transitional:i,paramsSerializer:r,headers:s}=n;i!==void 0&&yo.assertOptions(i,{silentJSONParsing:Cn.transitional(Cn.boolean),forcedJSONParsing:Cn.transitional(Cn.boolean),clarifyTimeoutError:Cn.transitional(Cn.boolean)},!1),r!=null&&(Z.isFunction(r)?n.paramsSerializer={serialize:r}:yo.assertOptions(r,{encode:Cn.function,serialize:Cn.function},!0)),yo.assertOptions(n,{baseUrl:Cn.spelling("baseURL"),withXsrfToken:Cn.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let o=s&&Z.merge(s.common,s[n.method]);s&&Z.forEach(["delete","get","head","post","put","patch","common"],g=>{delete s[g]}),n.headers=Zt.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(v){typeof v.runWhen=="function"&&v.runWhen(n)===!1||(l=l&&v.synchronous,a.unshift(v.fulfilled,v.rejected))});const c=[];this.interceptors.response.forEach(function(v){c.push(v.fulfilled,v.rejected)});let u,f=0,d;if(!l){const g=[ed.bind(this),void 0];for(g.unshift.apply(g,a),g.push.apply(g,c),d=g.length,u=Promise.resolve(n);f<d;)u=u.then(g[f++],g[f++]);return u}d=a.length;let p=n;for(f=0;f<d;){const g=a[f++],v=a[f++];try{p=g(p)}catch(m){v.call(this,m);break}}try{u=ed.call(this,p)}catch(g){return Promise.reject(g)}for(f=0,d=c.length;f<d;)u=u.then(c[f++],c[f++]);return u}getUri(e){e=Yi(this.defaults,e);const n=Ep(e.baseURL,e.url);return vp(n,e.params,e.paramsSerializer)}}Z.forEach(["delete","get","head","options"],function(e){Xi.prototype[e]=function(n,i){return this.request(Yi(i||{},{method:e,url:n,data:(i||{}).data}))}});Z.forEach(["post","put","patch"],function(e){function n(i){return function(s,o,a){return this.request(Yi(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}Xi.prototype[e]=n(),Xi.prototype[e+"Form"]=n(!0)});class Hc{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(s){n=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new Wr(s,o,a),n(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const n=this._listeners.indexOf(e);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const e=new AbortController,n=i=>{e.abort(i)};return this.subscribe(n),e.signal.unsubscribe=()=>this.unsubscribe(n),e.signal}static source(){let e;return{token:new Hc(function(r){e=r}),cancel:e}}}function ET(t){return function(n){return t.apply(null,n)}}function bT(t){return Z.isObject(t)&&t.isAxiosError===!0}const cc={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(cc).forEach(([t,e])=>{cc[e]=t});function Cp(t){const e=new Xi(t),n=op(Xi.prototype.request,e);return Z.extend(n,Xi.prototype,e,{allOwnKeys:!0}),Z.extend(n,e,null,{allOwnKeys:!0}),n.create=function(r){return Cp(Yi(t,r))},n}const bt=Cp(Ds);bt.Axios=Xi;bt.CanceledError=Wr;bt.CancelToken=Hc;bt.isCancel=yp;bt.VERSION=Rp;bt.toFormData=ia;bt.AxiosError=$e;bt.Cancel=bt.CanceledError;bt.all=function(e){return Promise.all(e)};bt.spread=ET;bt.isAxiosError=bT;bt.mergeConfig=Yi;bt.AxiosHeaders=Zt;bt.formToJSON=t=>Sp(Z.isHTMLForm(t)?new FormData(t):t);bt.getAdapter=wp.getAdapter;bt.HttpStatusCode=cc;bt.default=bt;const TT={name:"Blog",components:{BasePage:Vr,Container:Qo},setup(){const t=hr([]),e=hr([]),n=hr([]),i=hr([]),r=hr(""),s={};Bd(()=>{bt.get("/blog-data.json").then(a=>{a.data.forEach(c=>{t.value.push(c),e.value.length<3&&e.value.push({title:c.title,link:c.link}),c.tags.forEach(u=>{s[u]?s[u]++:s[u]=1})}),n.value=Object.entries(s).map(([c,u])=>({tag:c,count:u}))}).catch(a=>{console.error("Error loading blog data:",a)})});const o=fn(()=>{let a=t.value;return i.value.length>0&&(a=a.filter(l=>l.tags.some(c=>i.value.includes(c)))),r.value&&(a=a.filter(l=>{const c=l.title.toLowerCase(),u=l.description.toLowerCase(),f=l.tags.map(d=>d.toLowerCase());return c.includes(r.value.toLowerCase())||u.includes(r.value.toLowerCase())||f.some(d=>d.includes(r.value.toLowerCase()))})),a});return{blogItems:t,recentPosts:e,tags:n,selectedTags:i,searchQuery:r,filteredBlogItems:o}}},AT={class:"blog-content"},wT={class:"top-row"},RT={id:"recent",class:"list-unstyled"},CT={class:"dropdown"},PT={class:"dropdown-content"},DT=["value"],LT={class:"main-content"},IT={class:"blog-items",id:"blog-items"},UT={class:"read-more"},NT={class:"tags-container"};function FT(t,e,n,i,r,s){const o=Dt("Container"),a=Dt("router-link"),l=Dt("BasePage");return vt(),vi(l,null,{default:Ie(()=>[R("div",AT,[e[7]||(e[7]=R("h1",{class:"title"},"Blog",-1)),R("div",wT,[Ge(o,null,{title:Ie(()=>e[2]||(e[2]=[pe("Search")])),default:Ie(()=>[eu(R("input",{type:"text",id:"search-input",class:"searchbar",placeholder:"Search...","onUpdate:modelValue":e[0]||(e[0]=c=>i.searchQuery=c)},null,512),[[Kg,i.searchQuery]])]),_:1}),Ge(o,null,{title:Ie(()=>e[3]||(e[3]=[pe("Recent Posts")])),default:Ie(()=>[R("ul",RT,[(vt(!0),$t(Rt,null,Os(i.recentPosts,(c,u)=>(vt(),$t("li",{key:u},[Ge(a,{to:c.link},{default:Ie(()=>[pe(Fi(c.title),1)]),_:2},1032,["to"])]))),128))])]),_:1}),Ge(o,null,{title:Ie(()=>e[4]||(e[4]=[pe("Tags")])),default:Ie(()=>[R("div",CT,[e[5]||(e[5]=R("button",{class:"dropdown-btn"},"Select Tags",-1)),R("div",PT,[(vt(!0),$t(Rt,null,Os(i.tags,(c,u)=>(vt(),$t("label",{key:u},[eu(R("input",{type:"checkbox",value:c.tag,"onUpdate:modelValue":e[1]||(e[1]=f=>i.selectedTags=f)},null,8,DT),[[Zg,i.selectedTags]]),pe(" "+Fi(c.tag),1)]))),128))])])]),_:1})]),R("div",LT,[R("div",IT,[(vt(!0),$t(Rt,null,Os(i.filteredBlogItems,(c,u)=>(vt(),$t("div",{key:u,class:"blog-item"},[Ge(o,null,{title:Ie(()=>[pe(Fi(c.title),1)]),default:Ie(()=>[R("p",null,Fi(c.description),1),R("div",UT,[Ge(a,{to:c.link,style:{color:"#00ffcc"}},{default:Ie(()=>e[6]||(e[6]=[R("strong",null,"Read More",-1)])),_:2},1032,["to"])]),R("div",NT,[(vt(!0),$t(Rt,null,Os(c.tags,(f,d)=>(vt(),$t("span",{key:d,class:"tag",style:{backgroundColor:"#ff66b2"}},Fi(f),1))),128))])]),_:2},1024)]))),128))])])])]),_:1})}const OT=mn(TT,[["render",FT],["__scopeId","data-v-513882fe"]]),BT={name:"contact",components:{BasePage:Vr,Container:Qo}},zT={class:"contact-page"},kT={class:"containers-holder",style:{width:"70%"}};function HT(t,e,n,i,r,s){const o=Dt("Container"),a=Dt("BasePage");return vt(),vi(a,null,{default:Ie(()=>[R("div",zT,[e[2]||(e[2]=R("h1",{class:"title"},"Contact Me",-1)),e[3]||(e[3]=R("p",{class:"subtitle"}," I'd love to hear from you! Feel free to reach out using the form below or via my socials. ",-1)),R("div",kT,[Ge(o,null,{title:Ie(()=>e[0]||(e[0]=[pe(" Get In Touch ")])),default:Ie(()=>[e[1]||(e[1]=R("div",{class:"contact-details"},[R("p",null,[pe("Email: "),R("a",{href:"mailto:corniedj@mail.uc.edu"},"corniedj@mail.uc.edu")]),R("p",null,[pe("Phone: "),R("a",{href:"tel:+14408215281"},"440-821-5281")]),R("p",null,[pe(" LinkedIn: "),R("a",{href:"https://linkedin.com/in/derek-corniello",target:"_blank"},"linkedin.com/in/derek-corniello")])],-1))]),_:1})])])]),_:1})}const VT=mn(BT,[["render",HT],["__scopeId","data-v-8e2947ba"]]),GT={name:"Projects",components:{BasePage:Vr,Container:Qo}},WT={class:"containers-holder"};function XT(t,e,n,i,r,s){const o=Dt("Container"),a=Dt("BasePage");return vt(),vi(a,null,{default:Ie(()=>[e[28]||(e[28]=R("h1",{class:"title"},"Projects",-1)),R("div",WT,[Ge(o,null,{title:Ie(()=>e[0]||(e[0]=[R("a",{href:"https://github.com/DerekCorniello/DevBits",target:"_blank"},"DevBits",-1)])),default:Ie(()=>[e[1]||(e[1]=pe(" A developer-focused blog and knowledge-sharing platform where users can post concise, useful insights on project progress. Built using React Native for the frontend, Go for backend API, PostgreSQL for DB and AWS for hosting, DevBits emphasizes a clean, responsive design and easy content management.")),e[2]||(e[2]=R("br",null,null,-1)),e[3]||(e[3]=R("br",null,null,-1)),e[4]||(e[4]=R("div",{style:{"text-align":"center"}},[pe(" 🔨 "),R("strong",null,[R("u",null,"This project is still under development!")])],-1))]),_:1}),Ge(o,null,{title:Ie(()=>e[5]||(e[5]=[R("a",{href:"https://github.com/DerekCorniello/gitcmd",target:"_blank"},"gitcmd",-1)])),default:Ie(()=>[e[6]||(e[6]=pe(" A terminal-based application acting as a custom shell for Git commands. gitcmd simplifies workflow by offering a tailored prompt and intuitive command input. Built with Rust, it showcases my foray into low-level, high-performance programming and terminal application development. ")),e[7]||(e[7]=R("br",null,null,-1)),e[8]||(e[8]=R("br",null,null,-1)),e[9]||(e[9]=R("div",{style:{"text-align":"center"}},[pe(" 🔨 "),R("strong",null,[R("u",null,"This project is still under development!")])],-1))]),_:1}),Ge(o,null,{title:Ie(()=>e[10]||(e[10]=[R("a",{href:"https://reqinspect.com",target:"_blank"},"reqinspect.com",-1),pe(" / "),R("a",{href:"https://github.com/DerekCorniello/pip-req-valid",target:"_blank"},"pip-req-valid",-1)])),default:Ie(()=>[e[11]||(e[11]=pe(" A web app hosted on AWS that validates `requirements.txt` files for pip. It uses Go for backend processing and Vue.js for the frontend, both hosted on AWS architecture. It checks for missing or outdated dependencies and helps ensure that your Python project’s dependencies are up-to-date and properly formatted. "))]),_:1}),Ge(o,null,{title:Ie(()=>e[12]||(e[12]=[R("a",{href:"https://github.com/grillinr/Resume2Web",target:"_blank"},"Resume2Web",-1)])),default:Ie(()=>[e[13]||(e[13]=pe(" A Hackathon app that uses Vite, React/TypeScript, and Python/Flask. It takes a resume and converts it to a website with custom styling. This hackathon was my first and helped me learn more about full-stack development and new skills in a quick manner! "))]),_:1}),Ge(o,null,{title:Ie(()=>e[14]||(e[14]=[R("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup",target:"_blank"},"NeoVim",-1),pe(" / "),R("a",{href:"https://github.com/DerekCorniello/dotfiles",target:"_blank"},"Linux Setup",-1)])),default:Ie(()=>[e[15]||(e[15]=pe(" Here is my development setup that I do my programming and software development on. NeoVim enables me to edit, maintain, search through, and navigate a lot of files at one time, in an efficient manner. ")),e[16]||(e[16]=R("br",null,null,-1)),e[17]||(e[17]=pe(" My dotfiles contain my ArchLinux dotfiles setup, which include, but are not limited to, tmux, hyprland, oh my zsh, and kitty. "))]),_:1}),Ge(o,null,{title:Ie(()=>e[18]||(e[18]=[R("a",{href:"https://github.com/DerekCorniello/AmandaLynnDashboard",target:"_blank"},"Amanda Lynn Dashboard",-1)])),default:Ie(()=>[e[19]||(e[19]=pe(" I made a locally-running app for my (non-technical) Mom, who needed an app that showed her product for her small business. It tracks her revenue vs. expenses, stock, sales, and more! I update it regularly per her requests. It runs on a Vue frontend, Django for backend, SQLite for storage, and Docker to build and run the app. ")),e[20]||(e[20]=R("br",null,null,-1)),e[21]||(e[21]=pe(" Since she is not a tech expert, Docker was able to help her start and run the new app updates and changes without using the command line! "))]),_:1}),Ge(o,null,{title:Ie(()=>e[22]||(e[22]=[R("a",{href:"https://github.com/DerekCorniello/Game_BilliardsBonanza",target:"_blank"},"Billiards Bonanza",-1)])),default:Ie(()=>[e[23]||(e[23]=pe(" An 8-Ball game with a bunch of twists and funny add-ons. I made it in Unity using C#, and did all of the assets myself. This was a great experience in learning the syntax of C#, and learning more about programming languages and Unity! "))]),_:1}),Ge(o,null,{title:Ie(()=>e[24]||(e[24]=[R("a",{href:"https://github.com/DerekCorniello/CS4065-Discussion-Board",target:"_blank"},"Discussion Board",-1)])),default:Ie(()=>[e[25]||(e[25]=pe(" A live discussion board and chat app made directly in Java, using live, hand-rolled WebSockets, to enable real-time chatting with other people. It includes custom options for privileges and chatting lobbies! "))]),_:1}),Ge(o,null,{title:Ie(()=>e[26]||(e[26]=[pe(" That's not all! ")])),default:Ie(()=>[e[27]||(e[27]=R("div",{style:{"text-align":"center"}},[pe(" Please check out the rest of my projects "),R("a",{href:"https://github.com/DerekCorniello",target:"_blank"},[R("u",null,"here")]),pe("! ")],-1))]),_:1})])]),_:1})}const qT=mn(GT,[["render",XT],["__scopeId","data-v-4f21a87f"]]),$T={name:"BaseBlog",components:{BasePage:Vr},props:{title:{type:String,required:!0}}},jT={class:"blog-container"},YT={class:"blog-title"},KT={class:"blog-content"};function ZT(t,e,n,i,r,s){const o=Dt("BasePage");return vt(),vi(o,null,{default:Ie(()=>[R("div",jT,[R("h1",YT,Fi(n.title),1),R("div",KT,[Ao(t.$slots,"default",{},void 0,!0)])])]),_:3})}const JT=mn($T,[["render",ZT],["__scopeId","data-v-611ae1da"]]),QT={name:"blog1",components:{BaseBlog:JT}};function eA(t,e,n,i,r,s){const o=Dt("BaseBlog");return vt(),vi(o,{title:"My Transition from VSC*de to NeoVim"},{default:Ie(()=>e[0]||(e[0]=[R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})],-1),R("p",null,[R("i",null,[pe("My experience with transitioning from VSC*de to NeoVim. This includes setting up NeoVim, lazy.nvim, Mason, and other plugins that help my development cycle. Thank you to "),R("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),pe(" for providing guides to help me through this!")])],-1),R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})],-1),R("div",{style:{"text-align":"left"}},[pe(" It was a normal day at my office job, code upon code, bugfix upon bugfix. I finally had some time to sit and relax, as I was going to watch a demo from one of my coworkers. He was demonstrating some tooling that he had created for our internal systems. As I hopped into our virtual teams meeting and talked with sonme coworkers, awaiting the arrival of the demo, I was met with the Vim editor. "),R("br"),R("br"),R("i",null,[pe("Yuck, why would anyone want to use "),R("b",null,"that"),pe("?")]),pe(" I thought to myself. "),R("i",null,"It is so bare, so minimalistic. I'll just keep using what I have, no way that is better than my VSC*de Editor."),R("br"),R("br"),pe(" Little did I know, I would be sitting here, using NeoVim myself, writing this article, a few months later. Now, here's the short journey of how I migrated from VSC*de to NeoVim. "),R("br"),R("br"),R("br"),R("h3",null,"My introduction to Vim"),R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})]),pe(" In a course a few years ago in college, I was sitting in lecture and watching a live code demonstration, I was intrigued on how quickly the professor was able to move around the editor. He was using VSC*de though, so I was confused to say the least. "),R("i",null,"Maybe he's just a fast typer"),pe(" I thought. "),R("br"),R("br"),pe(" I was astonished watching him program, and one day I realized that he was not an incredibly fast, 200 WPS typer. Through the little I actually watched him type, and watching the screen change inside the editor, I was astonished as to how he was getting it done so quickly. I knew he wasn't using anything different in terms of hardware, so it "),R("b",null,"must"),pe(" be some sort of plugin. I went to his office one evening, and asked about it. "),R("br"),R("br"),R("i",null,"It's Vim motions"),pe(", he said. Vim? Motions? What is he talking about? Then he told me about Vi, the editor, and Vim, its successor. Once more, I was thoroughly confused. Why learn a whole new way to type when I have been using the same one for years? "),R("i",null,"It's different, you have to get a feel for it, but then it moves mountains in terms of productivity. You've seen me use it in class"),pe(". Hmmm... It is intriguing... "),R("br"),R("br"),R("br"),R("h3",null,"Going Through the (Vim) Motions"),R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})]),pe(' By now I have heard about "learning the motions is 90% of the battle". So I did what had to be done then, I installed the '),R("a",{href:"https://marketplace.visualstudio.com/items?itemName=vscodevim.vim"},"Vim plugin for VSC*de"),pe('. Striving for that quickness and efficiency I saw with my professor before, I set out to learn Vim motions. I think for most, the hardest part is starting. Seeing that "HJKL" move you around comes to a shock for most. It is '),R("i",null,"terribly"),pe(" different than a standard text editor. The notion of not using your a mouse scared me. Nonetheless, I buckled down. "),R("br"),R("br"),pe(" The key concept that really helped me in learning the motions is the structure. If you have ever watched a video instructing you how to use Vim, you should be familiar with the [command]-[count]-[object] structure. You can do many different things given this notation and Vim's supported commands. For example, if I wanted to edit the last 3 words (split by spaces), I can execute the command 'c3b' when I am on the end of the line! Now it is just learning "),R("i",null,"most"),pe(" of them. Here are some typical keystrokes used: "),R("br"),R("br"),R("ul",null,[R("li",null,"w - Jumps forward to the start of the word"),R("li",null,"e - Jumps forward to the end of the word"),R("li",null,"f - Jumps forward to the next occurence of the following character"),R("li",null,"d - Command to delete the selection"),R("li",null,"c - Command to change the selection")]),R("br"),pe(` One last key concept are the modes used in Vim. You need to be in "normal mode" to do the keystrokes above. Outside of that, there is insert, visual, and command mode. There are a few more, but those are the basic ones. Insert mode is where you can type as usual, like in any other editor. Visual mode is a way to visually select text for further manupulation. Command mode you are able to run different commands, such as the subsitute command, by typing the ':' character first, then the command. An example of that would be ':%s/Deerk/Derek/g' which will correct any typos of my name from 'Deerk' to 'Derek', on all lines, for as many occurences as there are per line. `),R("br"),R("br"),pe(" But the motions also hit a breaking point. Not all of the motions are, say, easy to remember or recognize. And VSC*de is not super easy to make these customizations in. Yes, there is JSON, but it just becomes increasingly harder and harder to manage customizations on a platform as I wanted to. Moreover, VSC*de was becoming overcrowded, slow to load, and overall a pain. "),R("br"),R("br"),pe(" Enter NeoVim. "),R("br"),R("br"),R("h4",null,"NeoVim, the Editor to End All Editors"),R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})]),pe(" After researching a few ways to make my wants and needs met in terms of editors. I found two content creators in "),R("a",{href:"https://www.youtube.com/@teej_dv"},"teej_dv"),pe(" and "),R("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),pe(". These two guys fueled my want and desire to not only use NeoVim, but become a better, more efficient programmer. Using some online guides mostly by those two, I was able to customize my own editor for what I need, and what I use. No overhead. No funny business. "),R("i",null,"No Microsoft"),pe(". Was it easy? Not at all. But definitely worth it. Once you understand the structure of the NeoVim setup, it becomes much easier to edit it to your liking. Add and take away language support, add plugins you need. Disable stuff you don't. It is cool to be able to have that much control. "),R("br"),R("br"),pe(" The best and most important things about learning NeoVim are understanding the structure of "),R("i",null,"your"),pe(" setup, what plugins you use, what "),R("a",{href:"https://neovim.io/doc/user/lsp.html"},"lsp"),pe(" (language server protocol) you use and what language you do it in. Plugins like "),R("a",{href:"https://github.com/nvim-treesitter/nvim-treesitter"},"treesitter"),pe(" and "),R("a",{href:"https://github.com/williamboman/mason-lspconfig.nvim"},"Mason"),pe(" are common ones you will see in many setups. As in mine, sometimes you see "),R("a",{href:"https://github.com/folke/lazy.nvim"},"lazy"),pe(", but more often than not, you see "),R("a",{href:"https://github.com/wbthomason/packer.nvim"},"Packer"),pe(". Ultimately the choice is up to you. Personally, I went a little bit crazy with all of the packages and ended up breaking my configuration, and starting over... more times than I remember. Writing Lua was not something I had ever done before either. I had never heard of an lsp before, so that was new as well!So I was thrown to the wolves, persay, but it ultimately landed me in a way better spot. "),R("br"),R("br"),pe(' Fast forward to today. I use NeoVim daily. For work, school, and personal use. I tell my friends that "I use NeoVim by the way", and have no regrets. I make macros that make me faster. More efficient. And best overall, it is '),R("i",null,"fun"),pe(". It has added an additional layer of enjoyment to programming for me. I strongly suggest you try it! Here is "),R("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup"},"my setup"),pe(" as of right now. There is also a good project being put on that helps beginners make their own setup faster, called "),R("a",{href:"https://github.com/nvim-lua/kickstart.nvim"},"Kickstart"),pe(". Please try it out! "),R("br"),R("br"),R("h4",null,"Concluding Remarks"),R("div",{class:"divider-container"},[R("div",{class:"divider-line"}),R("div",{class:"divider-glow"})]),pe(" In the end, I see myself standing with NeoVim for a very long time. I don't see myself moving back to VSC*de any time soon. The flexibility and understanding that I have for my editor is unremarkable, the speed is blazingly fast, and my enjoyment for writing scripts is through the roof. Please, push yourself to new heights and never stay comfortable in your environment. Strive for a better development environment. For efficiency. For *enjoying* coding. Thank you for reading, please reach out to me with any feedback! ")],-1)])),_:1})}const nd=mn(QT,[["render",eA],["__scopeId","data-v-28a0ec8a"]]),tA=BE({history:hE("/derekcorniello.github.io/"),routes:[{path:"/",name:"home",component:qh},{path:"/about",name:"about",component:YE},{path:"/blog",name:"blog",component:OT,children:[{path:"nvim-transition",name:"nvim-transition",component:nd}]},{path:"/contact",name:"contact",component:VT},{path:"/projects",name:"projects",component:qT},{path:"/resume",name:"Resume",beforeEnter:(t,e,n)=>{window.open("/resume.pdf","_blank"),n(!1)}},{path:"/blogs/nvim-transition",name:"nvim-transition",component:nd}]}),Pp=t_(FM);Pp.use(tA);Pp.mount("#app");
