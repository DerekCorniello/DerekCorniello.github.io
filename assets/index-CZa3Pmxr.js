...
`+s):i.stack=s}catch{}}throw i}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=Yi(this.defaults,n);const{transitional:i,paramsSerializer:r,headers:s}=n;i!==void 0&&yo.assertOptions(i,{silentJSONParsing:Cn.transitional(Cn.boolean),forcedJSONParsing:Cn.transitional(Cn.boolean),clarifyTimeoutError:Cn.transitional(Cn.boolean)},!1),r!=null&&(Z.isFunction(r)?n.paramsSerializer={serialize:r}:yo.assertOptions(r,{encode:Cn.function,serialize:Cn.function},!0)),yo.assertOptions(n,{baseUrl:Cn.spelling("baseURL"),withXsrfToken:Cn.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let o=s&&Z.merge(s.common,s[n.method]);s&&Z.forEach(["delete","get","head","post","put","patch","common"],g=>{delete s[g]}),n.headers=Zt.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(v){typeof v.runWhen=="function"&&v.runWhen(n)===!1||(l=l&&v.synchronous,a.unshift(v.fulfilled,v.rejected))});const c=[];this.interceptors.response.forEach(function(v){c.push(v.fulfilled,v.rejected)});let u,f=0,d;if(!l){const g=[ed.bind(this),void 0];for(g.unshift.apply(g,a),g.push.apply(g,c),d=g.length,u=Promise.resolve(n);f<d;)u=u.then(g[f++],g[f++]);return u}d=a.length;let p=n;for(f=0;f<d;){const g=a[f++],v=a[f++];try{p=g(p)}catch(m){v.call(this,m);break}}try{u=ed.call(this,p)}catch(g){return Promise.reject(g)}for(f=0,d=c.length;f<d;)u=u.then(c[f++],c[f++]);return u}getUri(e){e=Yi(this.defaults,e);const n=Ep(e.baseURL,e.url);return vp(n,e.params,e.paramsSerializer)}}Z.forEach(["delete","get","head","options"],function(e){Xi.prototype[e]=function(n,i){return this.request(Yi(i||{},{method:e,url:n,data:(i||{}).data}))}});Z.forEach(["post","put","patch"],function(e){function n(i){return function(s,o,a){return this.request(Yi(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}Xi.prototype[e]=n(),Xi.prototype[e+"Form"]=n(!0)});class Hc{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(s){n=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new Wr(s,o,a),n(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const n=this._listeners.indexOf(e);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const e=new AbortController,n=i=>{e.abort(i)};return this.subscribe(n),e.signal.unsubscribe=()=>this.unsubscribe(n),e.signal}static source(){let e;return{token:new Hc(function(r){e=r}),cancel:e}}}function DT(t){return function(n){return t.apply(null,n)}}function LT(t){return Z.isObject(t)&&t.isAxiosError===!0}const uc={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(uc).forEach(([t,e])=>{uc[e]=t});function Cp(t){const e=new Xi(t),n=op(Xi.prototype.request,e);return Z.extend(n,Xi.prototype,e,{allOwnKeys:!0}),Z.extend(n,e,null,{allOwnKeys:!0}),n.create=function(r){return Cp(Yi(t,r))},n}const bt=Cp(Ds);bt.Axios=Xi;bt.CanceledError=Wr;bt.CancelToken=Hc;bt.isCancel=yp;bt.VERSION=Rp;bt.toFormData=ra;bt.AxiosError=$e;bt.Cancel=bt.CanceledError;bt.all=function(e){return Promise.all(e)};bt.spread=DT;bt.isAxiosError=LT;bt.mergeConfig=Yi;bt.AxiosHeaders=Zt;bt.formToJSON=t=>Sp(Z.isHTMLForm(t)?new FormData(t):t);bt.getAdapter=wp.getAdapter;bt.HttpStatusCode=uc;bt.default=bt;const IT={name:"Blog",components:{BasePage:Vr,Container:ea},setup(){const t=hr([]),e=hr([]),n=hr([]),i=hr([]),r=hr(""),s={};Bd(()=>{bt.get("/blog-data.json").then(a=>{a.data.forEach(c=>{t.value.push(c),e.value.length<3&&e.value.push({title:c.title,link:c.link}),c.tags.forEach(u=>{s[u]?s[u]++:s[u]=1})}),n.value=Object.entries(s).map(([c,u])=>({tag:c,count:u}))}).catch(a=>{console.error("Error loading blog data:",a)})});const o=dn(()=>{let a=t.value;return i.value.length>0&&(a=a.filter(l=>l.tags.some(c=>i.value.includes(c)))),r.value&&(a=a.filter(l=>{const c=l.title.toLowerCase(),u=l.description.toLowerCase(),f=l.tags.map(d=>d.toLowerCase());return c.includes(r.value.toLowerCase())||u.includes(r.value.toLowerCase())||f.some(d=>d.includes(r.value.toLowerCase()))})),a});return{blogItems:t,recentPosts:e,tags:n,selectedTags:i,searchQuery:r,filteredBlogItems:o}},mounted(){document.title="Derek Corniello's Blogs"}},UT={class:"blog-content"},NT={class:"top-row"},FT={id:"recent",class:"list-unstyled"},OT={class:"dropdown"},BT={class:"dropdown-content"},zT=["value"],kT={class:"main-content"},HT={class:"blog-items",id:"blog-items"},VT={class:"read-more"},GT={class:"tags-container"};function WT(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("router-link"),l=Tt("BasePage");return gt(),vi(l,null,{default:Le(()=>[T("div",UT,[e[9]||(e[9]=T("h1",{class:"title"},"Blog",-1)),T("div",NT,[Be(o,null,{title:Le(()=>e[2]||(e[2]=[fe("Search")])),default:Le(()=>[eu(T("input",{type:"text",id:"search-input",class:"searchbar",placeholder:"Search...","onUpdate:modelValue":e[0]||(e[0]=c=>i.searchQuery=c)},null,512),[[Kg,i.searchQuery]])]),_:1}),Be(o,null,{title:Le(()=>e[3]||(e[3]=[fe("Recent Posts")])),default:Le(()=>[T("ul",FT,[(gt(!0),Wt(Ct,null,Os(i.recentPosts,(c,u)=>(gt(),Wt("li",{key:u},[Be(a,{to:c.link,class:ko(t.r-t.link)},{default:Le(()=>[fe(Fi(c.title),1)]),_:2},1032,["to","class"])]))),128))])]),_:1}),Be(o,null,{title:Le(()=>e[4]||(e[4]=[fe("Tags")])),default:Le(()=>[T("div",OT,[e[5]||(e[5]=T("button",{class:"dropdown-btn"},"Select Tags",-1)),T("div",BT,[(gt(!0),Wt(Ct,null,Os(i.tags,(c,u)=>(gt(),Wt("label",{key:u},[eu(T("input",{type:"checkbox",value:c.tag,"onUpdate:modelValue":e[1]||(e[1]=f=>i.selectedTags=f)},null,8,zT),[[Zg,i.selectedTags]]),fe(" "+Fi(c.tag),1)]))),128))])])]),_:1})]),T("div",kT,[T("div",HT,[(gt(!0),Wt(Ct,null,Os(i.filteredBlogItems,(c,u)=>(gt(),Wt("div",{key:u,class:"blog-item"},[Be(o,null,{title:Le(()=>[fe(Fi(c.title),1)]),default:Le(()=>[T("p",null,Fi(c.description),1),e[7]||(e[7]=T("br",null,null,-1)),T("div",VT,[Be(a,{to:c.link,class:"r-link",style:{color:"#00ffcc"}},{default:Le(()=>e[6]||(e[6]=[T("strong",null,"Read More",-1)])),_:2},1032,["to"])]),e[8]||(e[8]=T("br",null,null,-1)),T("div",GT,[(gt(!0),Wt(Ct,null,Os(c.tags,(f,d)=>(gt(),Wt("span",{key:d,class:"tag",style:{backgroundColor:"#ff66b2",color:"#FFFFFF"}},Fi(f),1))),128))])]),_:2},1024)]))),128))])])])]),_:1})}const XT=on(IT,[["render",WT],["__scopeId","data-v-b9463fff"]]),qT="/qrcode.png",$T={name:"contact",components:{BasePage:Vr,Container:ea},mounted(){document.title="Contact Derek Corniello"}},jT={class:"contact-page"},YT={class:"containers-holder",style:{width:"70%"}};function KT(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("BasePage");return gt(),vi(a,null,{default:Le(()=>[T("div",jT,[e[2]||(e[2]=T("h1",{class:"title"},"Contact Me",-1)),e[3]||(e[3]=T("p",{class:"subtitle"}," I'd love to hear from you! Feel free to reach out using the form below or via my socials. ",-1)),T("div",YT,[Be(o,null,{title:Le(()=>e[0]||(e[0]=[fe(" Get In Touch ")])),default:Le(()=>[e[1]||(e[1]=T("div",{class:"contact-details"},[T("p",null,[fe("Email: "),T("a",{href:"mailto:corniedj@mail.uc.edu"},"corniedj@mail.uc.edu")]),T("p",null,[fe("Phone: "),T("a",{href:"tel:+14408215281"},"440-821-5281")]),T("p",null,[fe(" LinkedIn: "),T("a",{href:"https://linkedin.com/in/derek-corniello",target:"_blank"},"linkedin.com/in/derek-corniello")])],-1))]),_:1})]),e[4]||(e[4]=T("a",{href:"https://dot.cards/DerekCorniello",target:"_blank",style:{"justify-content":"center","align-items":"center",display:"flex",margin:"1%"}},[T("img",{src:qT,alt:"My QR code to contact me!",style:{width:"60%",height:"auto","border-radius":"10%"}})],-1))])]),_:1})}const ZT=on($T,[["render",KT],["__scopeId","data-v-446bd847"]]),JT="/reqinspect.png",QT="/resume2web.png",eA="/billiardsbonanza.png",tA={name:"Projects",components:{BasePage:Vr,Container:ea},mounted(){document.title="Derek Corniello's Projects"}},nA={class:"containers-holder"};function iA(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("BasePage");return gt(),vi(a,null,{default:Le(()=>[e[38]||(e[38]=T("h1",{class:"title"},"Projects",-1)),e[39]||(e[39]=T("p",{class:"subtitle"},"Click any project name to view it's source and/or demo!",-1)),T("div",nA,[Be(o,null,{title:Le(()=>e[0]||(e[0]=[T("a",{href:"https://github.com/DerekCorniello/DevBits",target:"_blank",style:{"text-decoration":"underline white"}},"DevBits",-1)])),default:Le(()=>[e[1]||(e[1]=fe(" A developer-focused blog and knowledge-sharing platform where users can post concise, useful insights on project progress. Built using React Native for the frontend, Go for backend API, PostgreSQL for DB and AWS for hosting, DevBits emphasizes a clean, responsive design and easy content management.")),e[2]||(e[2]=T("br",null,null,-1)),e[3]||(e[3]=T("br",null,null,-1)),e[4]||(e[4]=T("div",{style:{"text-align":"center"}},[fe(" 🔨 "),T("strong",null,[T("u",null,"This project is still under development!")])],-1))]),_:1}),Be(o,null,{title:Le(()=>e[5]||(e[5]=[T("a",{href:"https://github.com/DerekCorniello/gitcmd",target:"_blank",style:{"text-decoration":"underline white"}},"gitcmd",-1),fe(" / "),T("a",{href:"https://crates.io/crates/gitcmd",target:"_blank",style:{"text-decoration":"underline white"}},"crates.io",-1)])),default:Le(()=>[e[6]||(e[6]=fe(" A terminal-based application acting as a custom shell for Git commands. gitcmd simplifies workflow by offering a tailored prompt and intuitive command input. Built with Rust, it showcases my foray into low-level, high-performance programming and terminal application development. "))]),_:1}),Be(o,null,{title:Le(()=>e[7]||(e[7]=[T("a",{href:"https://reqinspect.com",target:"_blank",style:{"text-decoration":"underline white"}},"reqinspect.com",-1),fe(" / "),T("a",{href:"https://github.com/DerekCorniello/pip-req-valid",target:"_blank",style:{"text-decoration":"underline white"}},"pip-req-valid",-1)])),default:Le(()=>[e[8]||(e[8]=fe(" A web app hosted on AWS that validates `requirements.txt` files for pip. It uses Go for backend processing and Vue.js for the frontend, both hosted on AWS architecture. It checks for missing or outdated dependencies and helps ensure that your Python project’s dependencies are up-to-date and properly formatted. ")),e[9]||(e[9]=T("br",null,null,-1)),e[10]||(e[10]=T("br",null,null,-1)),e[11]||(e[11]=T("img",{src:JT,alt:"[reqinspect.com Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[12]||(e[12]=[T("a",{href:"https://github.com/grillinr/Resume2Web",target:"_blank",style:{"text-decoration":"underline white"}},"Resume2Web",-1)])),default:Le(()=>[e[13]||(e[13]=fe(" A Hackathon app that uses Vite, React/TypeScript, and Python/Flask. It takes a resume and converts it to a website with custom styling. This hackathon was my first and helped me learn more about full-stack development and new skills in a quick manner! ")),e[14]||(e[14]=T("br",null,null,-1)),e[15]||(e[15]=T("br",null,null,-1)),e[16]||(e[16]=T("img",{src:QT,alt:"[Resume2Web Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[17]||(e[17]=[T("a",{href:"https://github.com/DerekCorniello/derekcorniello.github.io",target:"_blank",style:{"text-decoration":"underline white"}},"This Portfolio Site",-1)])),default:Le(()=>[e[18]||(e[18]=fe(" This webpage was made by me! I used Vite, Vue.js, JavaScript, and HTML/CSS to make a very cool and easily navigated portfolio site for viewers like you Three.js was also used to create the very cool backgrounds and word sphere on the landing page. I love space, so introducting you to ")),e[19]||(e[19]=T("strong",null,"my space",-1)),e[20]||(e[20]=fe(" has been a pleasure! "))]),_:1}),Be(o,null,{title:Le(()=>e[21]||(e[21]=[T("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup",target:"_blank",style:{"text-decoration":"underline white"}},"NeoVim",-1),fe(" / "),T("a",{href:"https://github.com/DerekCorniello/dotfiles",target:"_blank",style:{"text-decoration":"underline white"}},"Linux Setup",-1)])),default:Le(()=>[e[22]||(e[22]=fe(" Here is my development setup that I do my programming and software development on. NeoVim enables me to edit, maintain, search through, and navigate a lot of files at one time, in an efficient manner. ")),e[23]||(e[23]=T("br",null,null,-1)),e[24]||(e[24]=fe(" My dotfiles contain my ArchLinux dotfiles setup, which include, but are not limited to, tmux, hyprland, oh my zsh, and kitty. "))]),_:1}),Be(o,null,{title:Le(()=>e[25]||(e[25]=[T("a",{href:"https://github.com/DerekCorniello/AmandaLynnDashboard",target:"_blank",style:{"text-decoration":"underline white"}},"Amanda Lynn Dashboard",-1)])),default:Le(()=>[e[26]||(e[26]=fe(" I made a locally-running app for my (non-technical) Mom, who needed an app that showed her product for her small business. It tracks her revenue vs. expenses, stock, sales, and more! I update it regularly per her requests. It runs on a Vue frontend, Django for backend, SQLite for storage, and Docker to build and run the app. ")),e[27]||(e[27]=T("br",null,null,-1)),e[28]||(e[28]=fe(" Since she is not a tech expert, Docker was able to help her start and run the new app updates and changes without using the command line! "))]),_:1}),Be(o,null,{title:Le(()=>e[29]||(e[29]=[T("a",{href:"https://github.com/DerekCorniello/Game_BilliardsBonanza",target:"_blank",style:{"text-decoration":"underline white"}},"Billiards Bonanza",-1),fe(" / "),T("a",{href:"https://dcoolman.itch.io/Billiards-Bonanza",target:"_blank",style:{"text-decoration":"underline white"}},"Game Homepage",-1)])),default:Le(()=>[e[30]||(e[30]=fe(" An 8-Ball game with a bunch of twists and funny add-ons. I made it in Unity using C#, and did all of the assets myself. This was a great experience in learning the syntax of C#, and learning more about programming languages and Unity! ")),e[31]||(e[31]=T("br",null,null,-1)),e[32]||(e[32]=T("br",null,null,-1)),e[33]||(e[33]=T("img",{src:eA,alt:"[Billiards Bonanza Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[34]||(e[34]=[T("a",{href:"https://github.com/DerekCorniello/CS4065-Discussion-Board",target:"_blank",style:{"text-decoration":"underline white"}},"Discussion Board",-1)])),default:Le(()=>[e[35]||(e[35]=fe(" A live discussion board and chat app made directly in Java, using live, hand-rolled WebSockets, to enable real-time chatting with other people. It includes custom options for privileges and chatting lobbies! "))]),_:1}),Be(o,null,{title:Le(()=>e[36]||(e[36]=[fe(" That's not all! ")])),default:Le(()=>[e[37]||(e[37]=T("div",{style:{"text-align":"center"}},[fe(" Please check out the rest of my projects "),T("a",{href:"https://github.com/DerekCorniello",target:"_blank"},[T("u",null,"here")]),fe("! ")],-1))]),_:1})])]),_:1})}const rA=on(tA,[["render",iA],["__scopeId","data-v-ba6bb0f8"]]),sA={name:"BaseBlog",components:{BasePage:Vr},props:{title:{type:String,required:!0}}},oA={class:"blog-container"},aA={class:"blog-title"},lA={class:"blog-content"};function cA(t,e,n,i,r,s){const o=Tt("BasePage");return gt(),vi(o,null,{default:Le(()=>[T("div",oA,[T("h1",aA,Fi(n.title),1),T("div",lA,[Ao(t.$slots,"default",{},void 0,!0)])])]),_:3})}const uA=on(sA,[["render",cA],["__scopeId","data-v-db00ebc5"]]),fA={name:"blog1",components:{BaseBlog:uA}};function dA(t,e,n,i,r,s){const o=Tt("router-link"),a=Tt("BaseBlog");return gt(),vi(a,{title:"My Transition from VSC*de to NeoVim"},{default:Le(()=>[e[1]||(e[1]=T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})],-1)),e[2]||(e[2]=T("p",null,[T("i",null,[fe("My experience with transitioning from VSC*de to NeoVim. This includes setting up NeoVim, lazy.nvim, Mason, and other plugins that help my development cycle. Thank you to "),T("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),fe(" for providing guides to help me through this!")])],-1)),e[3]||(e[3]=T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})],-1)),e[4]||(e[4]=T("div",{style:{"text-align":"left"}},[fe(" It was a normal day at my office job, code upon code, bugfix upon bugfix. I finally had some time to sit and relax, as I was going to watch a demo from one of my coworkers. He was demonstrating some tooling that he had created for our internal systems. As I hopped into our virtual teams meeting and talked with sonme coworkers, awaiting the arrival of the demo, I was met with the Vim editor. "),T("br"),T("br"),T("i",null,[fe("Yuck, why would anyone want to use "),T("b",null,"that"),fe("?")]),fe(" I thought to myself. "),T("i",null,"It is so bare, so minimalistic. I'll just keep using what I have, no way that is better than my VSC*de Editor."),T("br"),T("br"),fe(" Little did I know, I would be sitting here, using NeoVim myself, writing this article, a few months later. Now, here's the short journey of how I migrated from VSC*de to NeoVim. "),T("br"),T("br"),T("br"),T("div",{style:{"text-align":"center","font-size":"1.5rem"}},[T("strong",null,[T("u",null,"My introduction to Vim")])]),T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})]),fe(" In a course a few years ago in college, I was sitting in lecture and watching a live code demonstration, I was intrigued on how quickly the professor was able to move around the editor. He was using VSC*de though, so I was confused to say the least. "),T("i",null,"Maybe he's just a fast typer"),fe(" I thought. "),T("br"),T("br"),fe(" I was astonished watching him program, and one day I realized that he was not an incredibly fast, 200 WPS typer. Through the little I actually watched him type, and watching the screen change inside the editor, I was astonished as to how he was getting it done so quickly. I knew he wasn't using anything different in terms of hardware, so it "),T("b",null,"must"),fe(" be some sort of plugin. I went to his office one evening, and asked about it. "),T("br"),T("br"),T("i",null,"It's Vim motions"),fe(", he said. Vim? Motions? What is he talking about? Then he told me about Vi, the editor, and Vim, its successor. Once more, I was thoroughly confused. Why learn a whole new way to type when I have been using the same one for years? "),T("i",null,"It's different, you have to get a feel for it, but then it moves mountains in terms of productivity. You've seen me use it in class"),fe(". Hmmm... It is intriguing... "),T("br"),T("br"),T("br"),T("div",{style:{"text-align":"center","font-size":"1.5rem"}},[T("strong",null,[T("u",null,"Going Through the (Vim) Motions")])]),T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})]),fe(' By now I have heard about "learning the motions is 90% of the battle". So I did what had to be done then, I installed the '),T("a",{href:"https://marketplace.visualstudio.com/items?itemName=vscodevim.vim"},"Vim plugin for VSC*de"),fe('. Striving for that quickness and efficiency I saw with my professor before, I set out to learn Vim motions. I think for most, the hardest part is starting. Seeing that "HJKL" move you around comes to a shock for most. It is '),T("i",null,"terribly"),fe(" different than a standard text editor. The notion of not using your a mouse scared me. Nonetheless, I buckled down. "),T("br"),T("br"),fe(" The key concept that really helped me in learning the motions is the structure. If you have ever watched a video instructing you how to use Vim, you should be familiar with the [command]-[count]-[object] structure. You can do many different things given this notation and Vim's supported commands. For example, if I wanted to edit the last 3 words (split by spaces), I can execute the command 'c3b' when I am on the end of the line! Now it is just learning "),T("i",null,"most"),fe(" of them. Here are some typical keystrokes used: "),T("br"),T("br"),T("ul",null,[T("li",null,"w - Jumps forward to the start of the word"),T("li",null,"e - Jumps forward to the end of the word"),T("li",null,"f - Jumps forward to the next occurence of the following character"),T("li",null,"d - Command to delete the selection"),T("li",null,"c - Command to change the selection")]),T("br"),fe(` One last key concept are the modes used in Vim. You need to be in "normal mode" to do the keystrokes above. Outside of that, there is insert, visual, and command mode. There are a few more, but those are the basic ones. Insert mode is where you can type as usual, like in any other editor. Visual mode is a way to visually select text for further manupulation. Command mode you are able to run different commands, such as the subsitute command, by typing the ':' character first, then the command. An example of that would be ':%s/Deerk/Derek/g' which will correct any typos of my name from 'Deerk' to 'Derek', on all lines, for as many occurences as there are per line. `),T("br"),T("br"),fe(" But the motions also hit a breaking point. Not all of the motions are, say, easy to remember or recognize. And VSC*de is not super easy to make these customizations in. Yes, there is JSON, but it just becomes increasingly harder and harder to manage customizations on a platform as I wanted to. Moreover, VSC*de was becoming overcrowded, slow to load, and overall a pain. "),T("br"),T("br"),fe(" Enter NeoVim. "),T("br"),T("br"),T("div",{style:{"text-align":"center","font-size":"1.5rem"}},[T("strong",null,[T("u",null,"NeoVim, the Editor to End All Editors")])]),T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})]),fe(" After researching a few ways to make my wants and needs met in terms of editors. I found two content creators in "),T("a",{href:"https://www.youtube.com/@teej_dv"},"teej_dv"),fe(" and "),T("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),fe(". These two guys fueled my want and desire to not only use NeoVim, but become a better, more efficient programmer. Using some online guides mostly by those two, I was able to customize my own editor for what I need, and what I use. No overhead. No funny business. "),T("i",null,"No Microsoft"),fe(". Was it easy? Not at all. But definitely worth it. Once you understand the structure of the NeoVim setup, it becomes much easier to edit it to your liking. Add and take away language support, add plugins you need. Disable stuff you don't. It is cool to be able to have that much control. "),T("br"),T("br"),fe(" The best and most important things about learning NeoVim are understanding the structure of "),T("i",null,"your"),fe(" setup, what plugins you use, what "),T("a",{href:"https://neovim.io/doc/user/lsp.html"},"lsp"),fe(" (language server protocol) you use and what language you do it in. Plugins like "),T("a",{href:"https://github.com/nvim-treesitter/nvim-treesitter"},"treesitter"),fe(" and "),T("a",{href:"https://github.com/williamboman/mason-lspconfig.nvim"},"Mason"),fe(" are common ones you will see in many setups. As in mine, sometimes you see "),T("a",{href:"https://github.com/folke/lazy.nvim"},"lazy"),fe(", but more often than not, you see "),T("a",{href:"https://github.com/wbthomason/packer.nvim"},"Packer"),fe(". Ultimately the choice is up to you. Personally, I went a little bit crazy with all of the packages and ended up breaking my configuration, and starting over... more times than I remember. Writing Lua was not something I had ever done before either. I had never heard of an lsp before, so that was new as well!So I was thrown to the wolves, persay, but it ultimately landed me in a way better spot. "),T("br"),T("br"),fe(' Fast forward to today. I use NeoVim daily. For work, school, and personal use. I tell my friends that "I use NeoVim by the way", and have no regrets. I make macros that make me faster. More efficient. And best overall, it is '),T("i",null,"fun"),fe(". It has added an additional layer of enjoyment to programming for me. I strongly suggest you try it! Here is "),T("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup"},"my setup"),fe(" as of right now. There is also a good project being put on that helps beginners make their own setup faster, called "),T("a",{href:"https://github.com/nvim-lua/kickstart.nvim"},"Kickstart"),fe(". Please try it out! "),T("br"),T("br"),T("div",{style:{"text-align":"center","font-size":"1.5rem"}},[T("strong",null,[T("u",null,"Concluding Remarks")])]),T("div",{class:"divider-container"},[T("div",{class:"divider-line"}),T("div",{class:"divider-glow"})]),fe(" In the end, I see myself standing with NeoVim for a very long time. I don't see myself moving back to VSC*de any time soon. The flexibility and understanding that I have for my editor is unremarkable, the speed is blazingly fast, and my enjoyment for writing scripts is through the roof. Please, push yourself to new heights and never stay comfortable in your environment. Strive for a better development environment. For efficiency. For *enjoying* coding. Thank you for reading, please reach out to me with any feedback! ")],-1)),e[5]||(e[5]=T("br",null,null,-1)),e[6]||(e[6]=T("br",null,null,-1)),Be(o,{style:{"text-align":"center","background-color":"#ff66b2",color:"white",padding:"10px 20px","border-radius":"5px","text-decoration":"none"},class:"r-link",to:"/blog"},{default:Le(()=>e[0]||(e[0]=[fe(" <- Back to Blogs ")])),_:1})]),_:1})}const nd=on(fA,[["render",dA],["__scopeId","data-v-ca44c612"]]),hA=WE({history:xE("/"),routes:[{path:"/",name:"home",component:qh},{path:"/about",name:"about",component:ib},{path:"/blog",name:"blog",component:XT,children:[{path:"nvim-transition",name:"nvim-transition",component:nd}]},{path:"/contact",name:"contact",component:ZT},{path:"/projects",name:"projects",component:rA},{path:"/resume",name:"Resume",beforeEnter:(t,e,n)=>{window.open("/resume.pdf","_blank"),n(!1)}},{path:"/blogs/nvim-transition",name:"nvim-transition",component:nd},{path:"/:pathMatch(.*)*",redirect:"/"}]}),Pp=t_(VM);Pp.use(hA);Pp.mount("#app");
