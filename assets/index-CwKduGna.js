...
`+s):i.stack=s}catch{}}throw i}}_request(e,n){typeof e=="string"?(n=n||{},n.url=e):n=e||{},n=Yi(this.defaults,n);const{transitional:i,paramsSerializer:r,headers:s}=n;i!==void 0&&yo.assertOptions(i,{silentJSONParsing:Cn.transitional(Cn.boolean),forcedJSONParsing:Cn.transitional(Cn.boolean),clarifyTimeoutError:Cn.transitional(Cn.boolean)},!1),r!=null&&(Z.isFunction(r)?n.paramsSerializer={serialize:r}:yo.assertOptions(r,{encode:Cn.function,serialize:Cn.function},!0)),yo.assertOptions(n,{baseUrl:Cn.spelling("baseURL"),withXsrfToken:Cn.spelling("withXSRFToken")},!0),n.method=(n.method||this.defaults.method||"get").toLowerCase();let o=s&&Z.merge(s.common,s[n.method]);s&&Z.forEach(["delete","get","head","post","put","patch","common"],g=>{delete s[g]}),n.headers=Zt.concat(o,s);const a=[];let l=!0;this.interceptors.request.forEach(function(v){typeof v.runWhen=="function"&&v.runWhen(n)===!1||(l=l&&v.synchronous,a.unshift(v.fulfilled,v.rejected))});const c=[];this.interceptors.response.forEach(function(v){c.push(v.fulfilled,v.rejected)});let u,f=0,d;if(!l){const g=[ed.bind(this),void 0];for(g.unshift.apply(g,a),g.push.apply(g,c),d=g.length,u=Promise.resolve(n);f<d;)u=u.then(g[f++],g[f++]);return u}d=a.length;let p=n;for(f=0;f<d;){const g=a[f++],v=a[f++];try{p=g(p)}catch(m){v.call(this,m);break}}try{u=ed.call(this,p)}catch(g){return Promise.reject(g)}for(f=0,d=c.length;f<d;)u=u.then(c[f++],c[f++]);return u}getUri(e){e=Yi(this.defaults,e);const n=Ep(e.baseURL,e.url);return vp(n,e.params,e.paramsSerializer)}}Z.forEach(["delete","get","head","options"],function(e){Xi.prototype[e]=function(n,i){return this.request(Yi(i||{},{method:e,url:n,data:(i||{}).data}))}});Z.forEach(["post","put","patch"],function(e){function n(i){return function(s,o,a){return this.request(Yi(a||{},{method:e,headers:i?{"Content-Type":"multipart/form-data"}:{},url:s,data:o}))}}Xi.prototype[e]=n(),Xi.prototype[e+"Form"]=n(!0)});class Hc{constructor(e){if(typeof e!="function")throw new TypeError("executor must be a function.");let n;this.promise=new Promise(function(s){n=s});const i=this;this.promise.then(r=>{if(!i._listeners)return;let s=i._listeners.length;for(;s-- >0;)i._listeners[s](r);i._listeners=null}),this.promise.then=r=>{let s;const o=new Promise(a=>{i.subscribe(a),s=a}).then(r);return o.cancel=function(){i.unsubscribe(s)},o},e(function(s,o,a){i.reason||(i.reason=new Wr(s,o,a),n(i.reason))})}throwIfRequested(){if(this.reason)throw this.reason}subscribe(e){if(this.reason){e(this.reason);return}this._listeners?this._listeners.push(e):this._listeners=[e]}unsubscribe(e){if(!this._listeners)return;const n=this._listeners.indexOf(e);n!==-1&&this._listeners.splice(n,1)}toAbortSignal(){const e=new AbortController,n=i=>{e.abort(i)};return this.subscribe(n),e.signal.unsubscribe=()=>this.unsubscribe(n),e.signal}static source(){let e;return{token:new Hc(function(r){e=r}),cancel:e}}}function DT(t){return function(n){return t.apply(null,n)}}function LT(t){return Z.isObject(t)&&t.isAxiosError===!0}const uc={Continue:100,SwitchingProtocols:101,Processing:102,EarlyHints:103,Ok:200,Created:201,Accepted:202,NonAuthoritativeInformation:203,NoContent:204,ResetContent:205,PartialContent:206,MultiStatus:207,AlreadyReported:208,ImUsed:226,MultipleChoices:300,MovedPermanently:301,Found:302,SeeOther:303,NotModified:304,UseProxy:305,Unused:306,TemporaryRedirect:307,PermanentRedirect:308,BadRequest:400,Unauthorized:401,PaymentRequired:402,Forbidden:403,NotFound:404,MethodNotAllowed:405,NotAcceptable:406,ProxyAuthenticationRequired:407,RequestTimeout:408,Conflict:409,Gone:410,LengthRequired:411,PreconditionFailed:412,PayloadTooLarge:413,UriTooLong:414,UnsupportedMediaType:415,RangeNotSatisfiable:416,ExpectationFailed:417,ImATeapot:418,MisdirectedRequest:421,UnprocessableEntity:422,Locked:423,FailedDependency:424,TooEarly:425,UpgradeRequired:426,PreconditionRequired:428,TooManyRequests:429,RequestHeaderFieldsTooLarge:431,UnavailableForLegalReasons:451,InternalServerError:500,NotImplemented:501,BadGateway:502,ServiceUnavailable:503,GatewayTimeout:504,HttpVersionNotSupported:505,VariantAlsoNegotiates:506,InsufficientStorage:507,LoopDetected:508,NotExtended:510,NetworkAuthenticationRequired:511};Object.entries(uc).forEach(([t,e])=>{uc[e]=t});function Cp(t){const e=new Xi(t),n=op(Xi.prototype.request,e);return Z.extend(n,Xi.prototype,e,{allOwnKeys:!0}),Z.extend(n,e,null,{allOwnKeys:!0}),n.create=function(r){return Cp(Yi(t,r))},n}const bt=Cp(Ds);bt.Axios=Xi;bt.CanceledError=Wr;bt.CancelToken=Hc;bt.isCancel=yp;bt.VERSION=Rp;bt.toFormData=ra;bt.AxiosError=$e;bt.Cancel=bt.CanceledError;bt.all=function(e){return Promise.all(e)};bt.spread=DT;bt.isAxiosError=LT;bt.mergeConfig=Yi;bt.AxiosHeaders=Zt;bt.formToJSON=t=>Sp(Z.isHTMLForm(t)?new FormData(t):t);bt.getAdapter=wp.getAdapter;bt.HttpStatusCode=uc;bt.default=bt;const IT={name:"Blog",components:{BasePage:Vr,Container:ea},setup(){const t=hr([]),e=hr([]),n=hr([]),i=hr([]),r=hr(""),s={};Bd(()=>{bt.get("/blog-data.json").then(a=>{a.data.forEach(c=>{t.value.push(c),e.value.length<3&&e.value.push({title:c.title,link:c.link}),c.tags.forEach(u=>{s[u]?s[u]++:s[u]=1})}),n.value=Object.entries(s).map(([c,u])=>({tag:c,count:u}))}).catch(a=>{console.error("Error loading blog data:",a)})});const o=dn(()=>{let a=t.value;return i.value.length>0&&(a=a.filter(l=>l.tags.some(c=>i.value.includes(c)))),r.value&&(a=a.filter(l=>{const c=l.title.toLowerCase(),u=l.description.toLowerCase(),f=l.tags.map(d=>d.toLowerCase());return c.includes(r.value.toLowerCase())||u.includes(r.value.toLowerCase())||f.some(d=>d.includes(r.value.toLowerCase()))})),a});return{blogItems:t,recentPosts:e,tags:n,selectedTags:i,searchQuery:r,filteredBlogItems:o}},mounted(){document.title="Derek Corniello's Blogs"}},UT={class:"blog-content"},NT={class:"top-row"},FT={id:"recent",class:"list-unstyled"},OT={class:"dropdown"},BT={class:"dropdown-content"},zT=["value"],kT={class:"main-content"},HT={class:"blog-items",id:"blog-items"},VT={class:"read-more"},GT={class:"tags-container"};function WT(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("router-link"),l=Tt("BasePage");return gt(),vi(l,null,{default:Le(()=>[b("div",UT,[e[9]||(e[9]=b("h1",{class:"title"},"Blog",-1)),b("div",NT,[Be(o,null,{title:Le(()=>e[2]||(e[2]=[ue("Search")])),default:Le(()=>[eu(b("input",{type:"text",id:"search-input",class:"searchbar",placeholder:"Search...","onUpdate:modelValue":e[0]||(e[0]=c=>i.searchQuery=c)},null,512),[[Kg,i.searchQuery]])]),_:1}),Be(o,null,{title:Le(()=>e[3]||(e[3]=[ue("Recent Posts")])),default:Le(()=>[b("ul",FT,[(gt(!0),Wt(Ct,null,Os(i.recentPosts,(c,u)=>(gt(),Wt("li",{key:u},[Be(a,{to:c.link,class:ko(t.r-t.link)},{default:Le(()=>[ue(Fi(c.title),1)]),_:2},1032,["to","class"])]))),128))])]),_:1}),Be(o,null,{title:Le(()=>e[4]||(e[4]=[ue("Tags")])),default:Le(()=>[b("div",OT,[e[5]||(e[5]=b("button",{class:"dropdown-btn"},"Select Tags",-1)),b("div",BT,[(gt(!0),Wt(Ct,null,Os(i.tags,(c,u)=>(gt(),Wt("label",{key:u},[eu(b("input",{type:"checkbox",value:c.tag,"onUpdate:modelValue":e[1]||(e[1]=f=>i.selectedTags=f)},null,8,zT),[[Zg,i.selectedTags]]),ue(" "+Fi(c.tag),1)]))),128))])])]),_:1})]),b("div",kT,[b("div",HT,[(gt(!0),Wt(Ct,null,Os(i.filteredBlogItems,(c,u)=>(gt(),Wt("div",{key:u,class:"blog-item"},[Be(o,null,{title:Le(()=>[ue(Fi(c.title),1)]),default:Le(()=>[b("p",null,Fi(c.description),1),e[7]||(e[7]=b("br",null,null,-1)),b("div",VT,[Be(a,{to:c.link,class:"r-link",style:{color:"#00ffcc"}},{default:Le(()=>e[6]||(e[6]=[b("strong",null,"Read More",-1)])),_:2},1032,["to"])]),e[8]||(e[8]=b("br",null,null,-1)),b("div",GT,[(gt(!0),Wt(Ct,null,Os(c.tags,(f,d)=>(gt(),Wt("span",{key:d,class:"tag",style:{backgroundColor:"#ff66b2",color:"#FFFFFF"}},Fi(f),1))),128))])]),_:2},1024)]))),128))])])])]),_:1})}const XT=on(IT,[["render",WT],["__scopeId","data-v-9f88a19b"]]),qT={name:"contact",components:{BasePage:Vr,Container:ea},mounted(){document.title="Contact Derek Corniello"}},$T={class:"contact-page"},jT={class:"containers-holder",style:{width:"70%"}};function YT(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("BasePage");return gt(),vi(a,null,{default:Le(()=>[b("div",$T,[e[2]||(e[2]=b("h1",{class:"title"},"Contact Me",-1)),e[3]||(e[3]=b("p",{class:"subtitle"}," I'd love to hear from you! Feel free to reach out using the form below or via my socials. ",-1)),b("div",jT,[Be(o,null,{title:Le(()=>e[0]||(e[0]=[ue(" Get In Touch ")])),default:Le(()=>[e[1]||(e[1]=b("div",{class:"contact-details"},[b("p",null,[ue("Email: "),b("a",{href:"mailto:corniedj@mail.uc.edu"},"corniedj@mail.uc.edu")]),b("p",null,[ue("Phone: "),b("a",{href:"tel:+14408215281"},"440-821-5281")]),b("p",null,[ue(" LinkedIn: "),b("a",{href:"https://linkedin.com/in/derek-corniello",target:"_blank"},"linkedin.com/in/derek-corniello")])],-1))]),_:1})])])]),_:1})}const KT=on(qT,[["render",YT],["__scopeId","data-v-1fdf6a2e"]]),ZT="/reqinspect.png",JT="/resume2web.png",QT="/billiardsbonanza.png",eA={name:"Projects",components:{BasePage:Vr,Container:ea},mounted(){document.title="Derek Corniello's Projects"}},tA={class:"containers-holder"};function nA(t,e,n,i,r,s){const o=Tt("Container"),a=Tt("BasePage");return gt(),vi(a,null,{default:Le(()=>[e[41]||(e[41]=b("h1",{class:"title"},"Projects",-1)),e[42]||(e[42]=b("p",{class:"subtitle"},"Click any project name to view it's source and/or demo!",-1)),b("div",tA,[Be(o,null,{title:Le(()=>e[0]||(e[0]=[b("a",{href:"https://github.com/DerekCorniello/DevBits",target:"_blank",style:{"text-decoration":"underline white"}},"DevBits",-1)])),default:Le(()=>[e[1]||(e[1]=ue(" A developer-focused blog and knowledge-sharing platform where users can post concise, useful insights on project progress. Built using React Native for the frontend, Go for backend API, PostgreSQL for DB and AWS for hosting, DevBits emphasizes a clean, responsive design and easy content management.")),e[2]||(e[2]=b("br",null,null,-1)),e[3]||(e[3]=b("br",null,null,-1)),e[4]||(e[4]=b("div",{style:{"text-align":"center"}},[ue(" 🔨 "),b("strong",null,[b("u",null,"This project is still under development!")])],-1))]),_:1}),Be(o,null,{title:Le(()=>e[5]||(e[5]=[b("a",{href:"https://github.com/DerekCorniello/gitcmd",target:"_blank",style:{"text-decoration":"underline white"}},"gitcmd",-1)])),default:Le(()=>[e[6]||(e[6]=ue(" A terminal-based application acting as a custom shell for Git commands. gitcmd simplifies workflow by offering a tailored prompt and intuitive command input. Built with Rust, it showcases my foray into low-level, high-performance programming and terminal application development. ")),e[7]||(e[7]=b("br",null,null,-1)),e[8]||(e[8]=b("br",null,null,-1)),e[9]||(e[9]=b("div",{style:{"text-align":"center"}},[ue(" 🔨 "),b("strong",null,[b("u",null,"This project is still under development!")])],-1))]),_:1}),Be(o,null,{title:Le(()=>e[10]||(e[10]=[b("a",{href:"https://reqinspect.com",target:"_blank",style:{"text-decoration":"underline white"}},"reqinspect.com",-1),ue(" / "),b("a",{href:"https://github.com/DerekCorniello/pip-req-valid",target:"_blank",style:{"text-decoration":"underline white"}},"pip-req-valid",-1)])),default:Le(()=>[e[11]||(e[11]=ue(" A web app hosted on AWS that validates `requirements.txt` files for pip. It uses Go for backend processing and Vue.js for the frontend, both hosted on AWS architecture. It checks for missing or outdated dependencies and helps ensure that your Python project’s dependencies are up-to-date and properly formatted. ")),e[12]||(e[12]=b("br",null,null,-1)),e[13]||(e[13]=b("br",null,null,-1)),e[14]||(e[14]=b("img",{src:ZT,alt:"[reqinspect.com Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[15]||(e[15]=[b("a",{href:"https://github.com/grillinr/Resume2Web",target:"_blank",style:{"text-decoration":"underline white"}},"Resume2Web",-1)])),default:Le(()=>[e[16]||(e[16]=ue(" A Hackathon app that uses Vite, React/TypeScript, and Python/Flask. It takes a resume and converts it to a website with custom styling. This hackathon was my first and helped me learn more about full-stack development and new skills in a quick manner! ")),e[17]||(e[17]=b("br",null,null,-1)),e[18]||(e[18]=b("br",null,null,-1)),e[19]||(e[19]=b("img",{src:JT,alt:"[Resume2Web Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[20]||(e[20]=[b("a",{href:"https://github.com/DerekCorniello/derekcorniello.github.io",target:"_blank",style:{"text-decoration":"underline white"}},"This Portfolio Site",-1)])),default:Le(()=>[e[21]||(e[21]=ue(" This webpage was made by me! I used Vite, Vue.js, JavaScript, and HTML/CSS to make a very cool and easily navigated portfolio site for viewers like you Three.js was also used to create the very cool backgrounds and word sphere on the landing page. I love space, so introducting you to ")),e[22]||(e[22]=b("strong",null,"my space",-1)),e[23]||(e[23]=ue(" has been a pleasure! "))]),_:1}),Be(o,null,{title:Le(()=>e[24]||(e[24]=[b("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup",target:"_blank",style:{"text-decoration":"underline white"}},"NeoVim",-1),ue(" / "),b("a",{href:"https://github.com/DerekCorniello/dotfiles",target:"_blank",style:{"text-decoration":"underline white"}},"Linux Setup",-1)])),default:Le(()=>[e[25]||(e[25]=ue(" Here is my development setup that I do my programming and software development on. NeoVim enables me to edit, maintain, search through, and navigate a lot of files at one time, in an efficient manner. ")),e[26]||(e[26]=b("br",null,null,-1)),e[27]||(e[27]=ue(" My dotfiles contain my ArchLinux dotfiles setup, which include, but are not limited to, tmux, hyprland, oh my zsh, and kitty. "))]),_:1}),Be(o,null,{title:Le(()=>e[28]||(e[28]=[b("a",{href:"https://github.com/DerekCorniello/AmandaLynnDashboard",target:"_blank",style:{"text-decoration":"underline white"}},"Amanda Lynn Dashboard",-1)])),default:Le(()=>[e[29]||(e[29]=ue(" I made a locally-running app for my (non-technical) Mom, who needed an app that showed her product for her small business. It tracks her revenue vs. expenses, stock, sales, and more! I update it regularly per her requests. It runs on a Vue frontend, Django for backend, SQLite for storage, and Docker to build and run the app. ")),e[30]||(e[30]=b("br",null,null,-1)),e[31]||(e[31]=ue(" Since she is not a tech expert, Docker was able to help her start and run the new app updates and changes without using the command line! "))]),_:1}),Be(o,null,{title:Le(()=>e[32]||(e[32]=[b("a",{href:"https://github.com/DerekCorniello/Game_BilliardsBonanza",target:"_blank",style:{"text-decoration":"underline white"}},"Billiards Bonanza",-1),ue(" / "),b("a",{href:"https://dcoolman.itch.io/Billiards-Bonanza",target:"_blank",style:{"text-decoration":"underline white"}},"Game Homepage",-1)])),default:Le(()=>[e[33]||(e[33]=ue(" An 8-Ball game with a bunch of twists and funny add-ons. I made it in Unity using C#, and did all of the assets myself. This was a great experience in learning the syntax of C#, and learning more about programming languages and Unity! ")),e[34]||(e[34]=b("br",null,null,-1)),e[35]||(e[35]=b("br",null,null,-1)),e[36]||(e[36]=b("img",{src:QT,alt:"[Billiards Bonanza Screenshot]"},null,-1))]),_:1}),Be(o,null,{title:Le(()=>e[37]||(e[37]=[b("a",{href:"https://github.com/DerekCorniello/CS4065-Discussion-Board",target:"_blank",style:{"text-decoration":"underline white"}},"Discussion Board",-1)])),default:Le(()=>[e[38]||(e[38]=ue(" A live discussion board and chat app made directly in Java, using live, hand-rolled WebSockets, to enable real-time chatting with other people. It includes custom options for privileges and chatting lobbies! "))]),_:1}),Be(o,null,{title:Le(()=>e[39]||(e[39]=[ue(" That's not all! ")])),default:Le(()=>[e[40]||(e[40]=b("div",{style:{"text-align":"center"}},[ue(" Please check out the rest of my projects "),b("a",{href:"https://github.com/DerekCorniello",target:"_blank"},[b("u",null,"here")]),ue("! ")],-1))]),_:1})])]),_:1})}const iA=on(eA,[["render",nA],["__scopeId","data-v-4dd82a00"]]),rA={name:"BaseBlog",components:{BasePage:Vr},props:{title:{type:String,required:!0}}},sA={class:"blog-container"},oA={class:"blog-title"},aA={class:"blog-content"};function lA(t,e,n,i,r,s){const o=Tt("BasePage");return gt(),vi(o,null,{default:Le(()=>[b("div",sA,[b("h1",oA,Fi(n.title),1),b("div",aA,[Ao(t.$slots,"default",{},void 0,!0)])])]),_:3})}const cA=on(rA,[["render",lA],["__scopeId","data-v-2fd45af7"]]),uA={name:"blog1",components:{BaseBlog:cA}};function fA(t,e,n,i,r,s){const o=Tt("router-link"),a=Tt("BaseBlog");return gt(),vi(a,{title:"My Transition from VSC*de to NeoVim"},{default:Le(()=>[e[1]||(e[1]=b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})],-1)),e[2]||(e[2]=b("p",null,[b("i",null,[ue("My experience with transitioning from VSC*de to NeoVim. This includes setting up NeoVim, lazy.nvim, Mason, and other plugins that help my development cycle. Thank you to "),b("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),ue(" for providing guides to help me through this!")])],-1)),e[3]||(e[3]=b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})],-1)),e[4]||(e[4]=b("div",{style:{"text-align":"left"}},[ue(" It was a normal day at my office job, code upon code, bugfix upon bugfix. I finally had some time to sit and relax, as I was going to watch a demo from one of my coworkers. He was demonstrating some tooling that he had created for our internal systems. As I hopped into our virtual teams meeting and talked with sonme coworkers, awaiting the arrival of the demo, I was met with the Vim editor. "),b("br"),b("br"),b("i",null,[ue("Yuck, why would anyone want to use "),b("b",null,"that"),ue("?")]),ue(" I thought to myself. "),b("i",null,"It is so bare, so minimalistic. I'll just keep using what I have, no way that is better than my VSC*de Editor."),b("br"),b("br"),ue(" Little did I know, I would be sitting here, using NeoVim myself, writing this article, a few months later. Now, here's the short journey of how I migrated from VSC*de to NeoVim. "),b("br"),b("br"),b("br"),b("div",{style:{"text-align":"center","font-size":"1.5rem"}},[b("strong",null,[b("u",null,"My introduction to Vim")])]),b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})]),ue(" In a course a few years ago in college, I was sitting in lecture and watching a live code demonstration, I was intrigued on how quickly the professor was able to move around the editor. He was using VSC*de though, so I was confused to say the least. "),b("i",null,"Maybe he's just a fast typer"),ue(" I thought. "),b("br"),b("br"),ue(" I was astonished watching him program, and one day I realized that he was not an incredibly fast, 200 WPS typer. Through the little I actually watched him type, and watching the screen change inside the editor, I was astonished as to how he was getting it done so quickly. I knew he wasn't using anything different in terms of hardware, so it "),b("b",null,"must"),ue(" be some sort of plugin. I went to his office one evening, and asked about it. "),b("br"),b("br"),b("i",null,"It's Vim motions"),ue(", he said. Vim? Motions? What is he talking about? Then he told me about Vi, the editor, and Vim, its successor. Once more, I was thoroughly confused. Why learn a whole new way to type when I have been using the same one for years? "),b("i",null,"It's different, you have to get a feel for it, but then it moves mountains in terms of productivity. You've seen me use it in class"),ue(". Hmmm... It is intriguing... "),b("br"),b("br"),b("br"),b("div",{style:{"text-align":"center","font-size":"1.5rem"}},[b("strong",null,[b("u",null,"Going Through the (Vim) Motions")])]),b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})]),ue(' By now I have heard about "learning the motions is 90% of the battle". So I did what had to be done then, I installed the '),b("a",{href:"https://marketplace.visualstudio.com/items?itemName=vscodevim.vim"},"Vim plugin for VSC*de"),ue('. Striving for that quickness and efficiency I saw with my professor before, I set out to learn Vim motions. I think for most, the hardest part is starting. Seeing that "HJKL" move you around comes to a shock for most. It is '),b("i",null,"terribly"),ue(" different than a standard text editor. The notion of not using your a mouse scared me. Nonetheless, I buckled down. "),b("br"),b("br"),ue(" The key concept that really helped me in learning the motions is the structure. If you have ever watched a video instructing you how to use Vim, you should be familiar with the [command]-[count]-[object] structure. You can do many different things given this notation and Vim's supported commands. For example, if I wanted to edit the last 3 words (split by spaces), I can execute the command 'c3b' when I am on the end of the line! Now it is just learning "),b("i",null,"most"),ue(" of them. Here are some typical keystrokes used: "),b("br"),b("br"),b("ul",null,[b("li",null,"w - Jumps forward to the start of the word"),b("li",null,"e - Jumps forward to the end of the word"),b("li",null,"f - Jumps forward to the next occurence of the following character"),b("li",null,"d - Command to delete the selection"),b("li",null,"c - Command to change the selection")]),b("br"),ue(` One last key concept are the modes used in Vim. You need to be in "normal mode" to do the keystrokes above. Outside of that, there is insert, visual, and command mode. There are a few more, but those are the basic ones. Insert mode is where you can type as usual, like in any other editor. Visual mode is a way to visually select text for further manupulation. Command mode you are able to run different commands, such as the subsitute command, by typing the ':' character first, then the command. An example of that would be ':%s/Deerk/Derek/g' which will correct any typos of my name from 'Deerk' to 'Derek', on all lines, for as many occurences as there are per line. `),b("br"),b("br"),ue(" But the motions also hit a breaking point. Not all of the motions are, say, easy to remember or recognize. And VSC*de is not super easy to make these customizations in. Yes, there is JSON, but it just becomes increasingly harder and harder to manage customizations on a platform as I wanted to. Moreover, VSC*de was becoming overcrowded, slow to load, and overall a pain. "),b("br"),b("br"),ue(" Enter NeoVim. "),b("br"),b("br"),b("div",{style:{"text-align":"center","font-size":"1.5rem"}},[b("strong",null,[b("u",null,"NeoVim, the Editor to End All Editors")])]),b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})]),ue(" After researching a few ways to make my wants and needs met in terms of editors. I found two content creators in "),b("a",{href:"https://www.youtube.com/@teej_dv"},"teej_dv"),ue(" and "),b("a",{href:"https://www.youtube.com/c/theprimeagen"},"ThePrimeagen"),ue(". These two guys fueled my want and desire to not only use NeoVim, but become a better, more efficient programmer. Using some online guides mostly by those two, I was able to customize my own editor for what I need, and what I use. No overhead. No funny business. "),b("i",null,"No Microsoft"),ue(". Was it easy? Not at all. But definitely worth it. Once you understand the structure of the NeoVim setup, it becomes much easier to edit it to your liking. Add and take away language support, add plugins you need. Disable stuff you don't. It is cool to be able to have that much control. "),b("br"),b("br"),ue(" The best and most important things about learning NeoVim are understanding the structure of "),b("i",null,"your"),ue(" setup, what plugins you use, what "),b("a",{href:"https://neovim.io/doc/user/lsp.html"},"lsp"),ue(" (language server protocol) you use and what language you do it in. Plugins like "),b("a",{href:"https://github.com/nvim-treesitter/nvim-treesitter"},"treesitter"),ue(" and "),b("a",{href:"https://github.com/williamboman/mason-lspconfig.nvim"},"Mason"),ue(" are common ones you will see in many setups. As in mine, sometimes you see "),b("a",{href:"https://github.com/folke/lazy.nvim"},"lazy"),ue(", but more often than not, you see "),b("a",{href:"https://github.com/wbthomason/packer.nvim"},"Packer"),ue(". Ultimately the choice is up to you. Personally, I went a little bit crazy with all of the packages and ended up breaking my configuration, and starting over... more times than I remember. Writing Lua was not something I had ever done before either. I had never heard of an lsp before, so that was new as well!So I was thrown to the wolves, persay, but it ultimately landed me in a way better spot. "),b("br"),b("br"),ue(' Fast forward to today. I use NeoVim daily. For work, school, and personal use. I tell my friends that "I use NeoVim by the way", and have no regrets. I make macros that make me faster. More efficient. And best overall, it is '),b("i",null,"fun"),ue(". It has added an additional layer of enjoyment to programming for me. I strongly suggest you try it! Here is "),b("a",{href:"https://github.com/DerekCorniello/NeoVim-Setup"},"my setup"),ue(" as of right now. There is also a good project being put on that helps beginners make their own setup faster, called "),b("a",{href:"https://github.com/nvim-lua/kickstart.nvim"},"Kickstart"),ue(". Please try it out! "),b("br"),b("br"),b("div",{style:{"text-align":"center","font-size":"1.5rem"}},[b("strong",null,[b("u",null,"Concluding Remarks")])]),b("div",{class:"divider-container"},[b("div",{class:"divider-line"}),b("div",{class:"divider-glow"})]),ue(" In the end, I see myself standing with NeoVim for a very long time. I don't see myself moving back to VSC*de any time soon. The flexibility and understanding that I have for my editor is unremarkable, the speed is blazingly fast, and my enjoyment for writing scripts is through the roof. Please, push yourself to new heights and never stay comfortable in your environment. Strive for a better development environment. For efficiency. For *enjoying* coding. Thank you for reading, please reach out to me with any feedback! ")],-1)),e[5]||(e[5]=b("br",null,null,-1)),e[6]||(e[6]=b("br",null,null,-1)),Be(o,{style:{"text-align":"center","background-color":"#ff66b2",color:"white",padding:"10px 20px","border-radius":"5px","text-decoration":"none"},class:"r-link",to:"/blog"},{default:Le(()=>e[0]||(e[0]=[ue(" <- Back to Blogs ")])),_:1})]),_:1})}const nd=on(uA,[["render",fA],["__scopeId","data-v-a8bc8437"]]),dA=WE({history:xE("/"),routes:[{path:"/",name:"home",component:qh},{path:"/about",name:"about",component:ib},{path:"/blog",name:"blog",component:XT,children:[{path:"nvim-transition",name:"nvim-transition",component:nd}]},{path:"/contact",name:"contact",component:KT},{path:"/projects",name:"projects",component:iA},{path:"/resume",name:"Resume",beforeEnter:(t,e,n)=>{window.open("/resume.pdf","_blank"),n(!1)}},{path:"/blogs/nvim-transition",name:"nvim-transition",component:nd},{path:"/:pathMatch(.*)*",redirect:"/"}]}),Pp=t_(VM);Pp.use(dA);Pp.mount("#app");
