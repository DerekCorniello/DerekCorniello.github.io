...
const blogPosts: Post[] = [
    {
        ...
        excerpt:
            'Building a custom Dactyl Manuform keyboard from scratch - the BOM, firmware, handwiring process, and lessons learned along the way.',
        tags: ['Hardware', 'DIY'],
    },
    {
        ...
        excerpt:
            'My experience transitioning from VSC*de to NeoVim, including setting up lazy.nvim, Mason, and other plugins that improved my development workflow.',
